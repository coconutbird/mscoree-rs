...
pub unsafe trait ICLRControl: IUnknown {
    ...
    pub unsafe fn GetCLRManager(&self, riid: *const GUID, ppObject: *mut *mut c_void) -> HRESULT;
...
pub unsafe trait IHostControl: IUnknown {
    ...
    pub unsafe fn GetHostManager(&self, riid: *const GUID, ppObject: *mut *mut c_void) -> HRESULT;
...
pub unsafe trait ICLRGCManager2: IUnknown {
    ...
    pub unsafe fn SetGCStartupLimitsEx(&self, SegmentSize: u64, MaxGen0Size: u64) -> HRESULT;
}
...
pub unsafe trait ICLRErrorReportingManager: IUnknown {
    ...
    pub unsafe fn GetBucketParametersForCurrentException(&self, pParams: *mut c_void) -> HRESULT;
...
pub unsafe trait ICLRPolicyManager: IUnknown {
    ...
    pub unsafe fn SetDefaultAction(&self, operation: u32, action: u32) -> HRESULT;

    /// Set timeout for an operation.
    pub unsafe fn SetTimeout(&self, operation: u32, dwMilliseconds: u32) -> HRESULT;

    /// Set action on a failure type.
    pub unsafe fn SetActionOnFailure(&self, failure: u32, action: u32) -> HRESULT;

    /// Set unhandled exception policy.
    pub unsafe fn SetUnhandledExceptionPolicy(&self, policy: u32) -> HRESULT;
}
...
pub unsafe trait ICLRHostProtectionManager: IUnknown {
    ...
    pub unsafe fn SetProtectedCategories(&self, categories: u32) -> HRESULT;
