...
pub unsafe trait ICorDebugManagedCallback: IUnknown {
    ...
    pub unsafe fn Breakpoint(
        ...
        pBreakpoint: *mut IUnknown,
    ) -> HRESULT;

    /// Called when a stepper completes.
    pub unsafe fn StepComplete(
        &self,
        pAppDomain: *mut IUnknown,
        pThread: *mut IUnknown,
        pStepper: *mut IUnknown,
        reason: u32,
    ) -> HRESULT;
    ...
    pub unsafe fn CreateThread(&self, pAppDomain: *mut IUnknown, pThread: *mut IUnknown)
    -> HRESULT;
    ...
    pub unsafe fn UnloadModule(&self, pAppDomain: *mut IUnknown, pModule: *mut IUnknown)
    -> HRESULT;
    ...
    pub unsafe fn DebuggerError(
        &self,
        pProcess: *mut IUnknown,
        errorHR: HRESULT,
        errorCode: u32,
    ) -> HRESULT;

    /// Called for log messages.
    pub unsafe fn LogMessage(
        &self,
        pAppDomain: *mut IUnknown,
        pThread: *mut IUnknown,
        lLevel: i32,
        pLogSwitchName: *const u16,
        pMessage: *const u16,
    ) -> HRESULT;

    /// Called when a log switch changes.
    pub unsafe fn LogSwitch(
        &self,
        pAppDomain: *mut IUnknown,
        pThread: *mut IUnknown,
        lLevel: i32,
        ulReason: u32,
        pLogSwitchName: *const u16,
        pParentName: *const u16,
    ) -> HRESULT;

    /// Called when an app domain is created.
    pub unsafe fn CreateAppDomain(
        &self,
        pProcess: *mut IUnknown,
        pAppDomain: *mut IUnknown,
    ) -> HRESULT;
    ...
    pub unsafe fn LoadAssembly(
        &self,
        pAppDomain: *mut IUnknown,
        pAssembly: *mut IUnknown,
    ) -> HRESULT;

    /// Called when an assembly is unloaded.
    pub unsafe fn UnloadAssembly(
        &self,
        pAppDomain: *mut IUnknown,
        pAssembly: *mut IUnknown,
    ) -> HRESULT;
    ...
    pub unsafe fn UpdateModuleSymbols(
        &self,
        pAppDomain: *mut IUnknown,
        pModule: *mut IUnknown,
        pSymbolStream: *mut IUnknown,
    ) -> HRESULT;

    /// Called for edit and continue remap.
    pub unsafe fn EditAndContinueRemap(
        &self,
        pAppDomain: *mut IUnknown,
        pThread: *mut IUnknown,
    ...
    pub unsafe fn BreakpointSetError(
        &self,
        pAppDomain: *mut IUnknown,
        pThread: *mut IUnknown,
        pBreakpoint: *mut IUnknown,
...
pub unsafe trait ICorDebugManagedCallback2: IUnknown {
    ...
    pub unsafe fn FunctionRemapOpportunity(
        &self,
        pAppDomain: *mut IUnknown,
        pThread: *mut IUnknown,
        pOldFunction: *mut IUnknown,
        pNewFunction: *mut IUnknown,
        oldILOffset: u32,
    ) -> HRESULT;

    /// Called when a connection is created.
    pub unsafe fn CreateConnection(
        &self,
        pProcess: *mut IUnknown,
        dwConnectionId: u32,
        pConnName: *const u16,
    ...
    pub unsafe fn DestroyConnection(&self, pProcess: *mut IUnknown, dwConnectionId: u32)
    -> HRESULT;
    ...
    pub unsafe fn FunctionRemapComplete(
        &self,
        pAppDomain: *mut IUnknown,
        pThread: *mut IUnknown,
        pFunction: *mut IUnknown,
    ...
    pub unsafe fn MDANotification(
        &self,
        pController: *mut IUnknown,
        pThread: *mut IUnknown,
        pMDA: *mut IUnknown,
    ) -> HRESULT;
}
...
pub unsafe trait ICorDebugManagedCallback3: IUnknown {
    ...
    pub unsafe fn CustomNotification(
        &self,
        pThread: *mut IUnknown,
        pAppDomain: *mut IUnknown,
    ) -> HRESULT;
