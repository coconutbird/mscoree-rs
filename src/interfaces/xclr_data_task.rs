...
pub unsafe trait IXCLRDataTask: IUnknown {
    ...
    pub unsafe fn GetCurrentAppDomain(&self, appDomain: *mut *mut IUnknown) -> HRESULT;
    ...
    pub unsafe fn CreateStackWalk(&self, flags: u32, stackWalk: *mut *mut IUnknown) -> HRESULT;
    ...
    pub unsafe fn GetCurrentExceptionState(&self, exception: *mut *mut IUnknown) -> HRESULT;
    ...
    pub unsafe fn GetLastExceptionState(&self, exception: *mut *mut IUnknown) -> HRESULT;
}
